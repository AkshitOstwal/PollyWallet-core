...
const sendTokenHeading = TextStyle(fontSize: 25, fontWeight: FontWeight.bold, color: Colors.black87);
TextStyle sendTokenHeadingAlt = TextStyle(fontSize: 25, fontWeight: FontWeight.bold, color: primaryColor);
const ethIcon = "assets/images/ethIcon.png";
const maticIcon = "assets/images/maticIcon.png";
const downIcon = "assets/images/downArrow.png";
